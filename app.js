...
// The student object: Student {name: "Joe", age: 100, hometown: "Schmoe"}

// 2. What is "this" when joe.scopeArrow() is invoked?
// The window object: Window {window: Window, self: Window, document: document, name: "", location: Location, …}

// 3. Explain why "this" is different when an arrow function is used.
// Because arrow functions retain the 'this' value of the enclosing functional scope, which is window in this case.
